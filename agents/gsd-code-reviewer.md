...
description:
    ...
    maintainability. Use immediately after writing or modifying code. MUST BE USED for all code
    changes.
...
1. `.planning/codebase/CONVENTIONS.md` — project coding conventions discovered by codebase mapping
2. `CLAUDE.md` — project-specific instructions and constraints
